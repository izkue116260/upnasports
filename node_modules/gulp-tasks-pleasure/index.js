...
var plugins = require('gulp-load-plugins')({
    ...
    var paths = {
      ...
      bbdd: {
        source: 'src/assets/bases-de-datos/',
        destination: 'assets/bases-de-datos/'
      },
      styles: {
    ...
    var options = {
        ...
        // ----- Images ----- //
        images: {
          files: paths.images.source + '**/*.{png,gif,jpg,svg,xml,webmanifest,webp}',
    ...
    // require('./gulp-tasks/python')(gulp, plugins, options);
